...
```{r Figure3, echo=FALSE, fig.height=3, fig.width=5.75}
...
```{r FigureS3, echo=FALSE, fig.height=3, fig.width=5.75}
...
write.xlsx(list(results_emahan, results_emahan_modsel, results_quag, results_quag_modsel), file="HFD_DiffR_analysis.xlsx", 
...
```{r FigureS4, fig.width=7.5, fig.height=5}
...
fS4_1 + wrap_elements(panel=dfS4_2) + wrap_elements(panel=dfS4_3) + wrap_elements(plot=dfS4_4) + wrap_elements(panel=fS4_5) + wrap_elements(panel=dfS4_6) + plot_layout(design = layout, heights =  c(0.75,1), widths = c(1,0.2,1,1)) + plot_annotation(tag_levels = 'A')
...
write.xlsx(list(results_keto, results_keto_modsel, results_keto_iec, results_keto_iec_modsel), file="KD_DiffR_analysis.xlsx", 
           creator = "Bharath Ananthasubramaniam", 
           asTable = c(TRUE, TRUE, TRUE, TRUE, TRUE, TRUE),
           sheetName = c("Hyp. testing - liver (limma)", "Model selection - liver", "Hyp. testing - IEC (limma)", "Model selection - IEC"),
           borders = rep("surrounding",4))
...
write.xlsx(list(results_pei_deseq, results_pei_modsel), file="p66KO_DiffR_analysis.xlsx", 
           creator = "Bharath Ananthasubramaniam", 
